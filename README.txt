...
with the addition of 4 new content types: client, project, iteration, and task 
(requires Dexterity). It also includes a tool to automate creation of iterations. 
